...
import { Indicator } from "./cipher-b.service";

@Injectable()
export class SuperTrendService implements Indicator {
  constructor() {}

  getIndicator(chart): Promise<SuperTrend> {
    return new Promise((resolve, reject) => {
      TradingView.getIndicator("PUB;VfOPXWDHDPhORvJYRTcuHOyeqpOcRR45").then(async indicator => {
